...
forge script script/dev/Synthesize.s.sol:DeploySynthesizer -f $RPC_URL --broadcast 
...
if [ "$fixture" -eq "1" ]; then
  echo "Running fixture scripts."
    ...
    forge script script/dev/Synthesize.s.sol:FixtureSynthesizer -f $RPC_URL --broadcast
