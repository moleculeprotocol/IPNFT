 ...
 * @title Fixtures
 * @author
 * @notice execute Ipnft.s.sol first
 */
contract FixtureScript is Script {
    ...
    Mintpass mintpass = Mintpass(vm.envAddress("MINTPASS_ADDRESS"));
    ...
    function run() public {
        ...
        vm.startBroadcast(deployer);
        FakeERC20 erc20 = new FakeERC20("ERC20 Token", "ERC20");
        vm.stopBroadcast();
        ...
        dealERC20(bob, 1000 ether, erc20);
        dealERC20(alice, 1000 ether, erc20);

        uint256 listingId = createListing(bob, tokenId, 1 ether, erc20);
