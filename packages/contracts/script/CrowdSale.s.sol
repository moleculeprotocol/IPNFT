...
contract DeployStakedCrowdSale is CommonScript {
    function run() public {
        ...
        ITokenVesting vestedDaoToken = ITokenVesting(vm.envAddress("VDAO_TOKEN_ADDRESS"));
        vestedDaoToken.grantRole(ROLE_CREATE_SCHEDULE, address(stakedLockingCrowdSale));
...
contract FixtureCrowdSale is CommonScript {
    ...
    function prepareAddresses() internal virtual override {
        ...
        auctionToken = FakeERC20(vm.envAddress("IPTS_ADDRESS"));
...
contract FixtureStakedCrowdSale is FixtureCrowdSale {
    ...
    function prepareAddresses() internal override {
        super.prepareAddresses();
        vestedDaoToken = ITokenVesting(vm.envAddress("VDAO_TOKEN_ADDRESS"));
...
contract ClaimSale is CommonScript {
    function run() public {
        ...
        FakeERC20 auctionToken = FakeERC20(vm.envAddress("IPTS_ADDRESS"));
